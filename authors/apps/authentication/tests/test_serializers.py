...
from authors.apps.authentication.serializers import (LoginSerializer, UserSerializer)
...
class TestLoginSerializer(TestCase):
    ...
    def test_email_not_in_validate_function(self):
        ...
        self.assertEqual(error.exception.args[0], 'An email address is required to log in.')
    ...
    def test_password_not_in_validate_function(self):
        ...
        self.assertEqual(error.exception.args[0], 'A password is required to log in.')
    ...
    def test_update_user(self):
        ...
        self.assertEqual(UserSerializer().update(update_instance, update_data), update_instance)
